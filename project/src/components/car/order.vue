  ...
  <div id="car">
    ...
    <section>
      ...
      <div class="order-message">
        ...
        <div class="order-list" v-for="(item, index) in shop">
          <div class="order-list-title flex-start-center">
            <img src="../../../static/img/icon-shop-white.png" /> {{item.name}}
          </div>
          <div class="order-goods-list flex-start-start" v-for="(goods, idx) in item.list" :key="idx">
            <img :src="goods.img" />
      ...
      <div class="nursing-order" v-if="nursing">
        <el-form :model="nRuleForm" :rules="nRules" ref="nRuleForm" label-width="140px" class="demo-ruleForm">
      ...
      <div class="order-other">
        <router-link to="/" class="flex-between-center">
          优惠券
          <span>
      		{{coupon}}
    ...
    <el-dialog title="发票信息" :visible.sync="dialogVisible" width="50%">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="demo-ruleForm">
        ...
        <el-form-item :label="ruleForm.radio == 1 ? '邮箱地址' : '收货地址'" prop="address">
          <el-input v-model="ruleForm.address" :placeholder="ruleForm.radio == 1 ? '用于接收电子发票' : '用于接收纸质发票'">></el-input>
        </el-form-item>
      </el-form>
