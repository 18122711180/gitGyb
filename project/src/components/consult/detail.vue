<template>
  <div id="consultDetail">
    ...
    <section>
      ...
      <div class="consult-introduce" v-html="consult.introduce">
      </div>
      ...
      <div class="comment-main">
      	<div class="comment-list flex-start-start" v-for="(item,index) in consult.commentList" :key="index">
    ...
    data() {
      return {
        ...
        consult: {
          ...
          date: '2019-4-26',
          time: '19:01',
          introduce: '<p>百种疾病可导致眩晕，出现眩晕勿轻视！专家解开眩晕背后的真相！</p>',
          helpful: 123,
          comment: 652,
          commentList: [
          	{
          		...
          		name: '用户名123456',
          		introduce: '我是内容我是内容我是内容我是内容我是内容我是内容我是我是内容我是内容我是内容我是内容我是内容我是内容我是我是内容我是内容我是内容我是内容我是内容我内容我是内容我是内容我是内容我是内容内容我是内容我是内容我是内容我',
          		time: '3月29日 14:32',
          		reply:[
          			{
          				name: '用户12332',
