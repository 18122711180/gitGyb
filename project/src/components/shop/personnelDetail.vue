<template>
  <div id="personnelDetail">
    <my-head :login='login' />
    <section>
      <div class="doctor-top flex-between-start">
        <div class="doctor-top-left">
          <div class="doctor-top-img">
            <img :src="doctor.img" />
          </div>
          <div class="doctor-basice flex-center-center">
          	<span>韩冬梅</span> 
          	<span>女</span> 
          	<span>主治医师</span> 
          </div>
          <div class="doctor-basice flex-center-center">
          	<span class="worktime">从业12年</span>
          </div>
        </div>
