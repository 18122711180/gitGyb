      ...
      <div class="doctor-bottom">
        ...
        <template v-if="doctorDetailType == 1">
          ...
          <div class="doctor-bottom-server">
            <img :src="item" v-for="(item,index) in doctor.certificateImage" :key="index">
            <!-- <img
              src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3696080265,4026547851&fm=26&gp=0.jpg"
            >-->
          </div>
        </template>
        <template v-else>
...
export default {
      ...
      evaluaterList: [
        {
          ...
          score: 5,
          introduce:
            "最近一些日子，连续看了好几位耳鼻喉科的医生，每个医生个人风格，施治的观念都不相同，但是，无一例外，都拥有精湛的医术，高尚的医德以及对患者温暖体贴的态度。张医生就是这样的一位好医生。医生关爱患者，患者也应该理解支持医生的工作。患病是痛苦的，但是碰到张医生是幸运的，谢谢！",
          time: "3月29日 14：32",
          imgList: [
            "http://img0.imgtn.bdimg.com/it/u=1923368568,3957327670&fm=26&gp=0.jpg",
  ...
  methods: {
    getPgzhgInfo(id) {
      ...
      this.post("/yiqi-api/api/hg/pzhgInformation", v)
        .then(res => {
