    ...
    <section>
      ...
      <div class="exchange-bottom">
        ...
        <div class="exchange-bottom-list flex-start-start">
          <span class="exchange-bottom-list-left exchange-bottom-list-left-center"><i>*</i>申请原因:</span>
          <div class="exchange-bottom-list-right">
            <el-select v-model="reason" olaceholder="请选择退换货原因">
              <el-option v-for="item in reasonData" :label="item.label" :value="item.value" :key="item.value">
              </el-option>
            </el-select>
          </div>
        </div>
